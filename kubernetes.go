...
request.Header.Set("Accept", "application/json, *
	...
	PodlistL2:=len(podList.Items)

	if (PodlistL1<PodlistL2){

err:=podPhaseTable.PodListClassify(podList.Items[0])
db.dataBaseInserion(podPhaseTable.PodSucceeded[0])
if err!=nil {
